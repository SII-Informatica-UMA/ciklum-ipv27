...
create table ejs (duracion_minutos bigint not null, ejercicio_id bigint not null, repeticiones bigint not null, rutina_id bigint not null, series bigint not null, primary key (ejercicio_id, rutina_id));
